                ...
                <div class="card-body">
                    ...
                    @else
                        <div class="alert alert-info">
                            <h5><i class="bi bi-info-circle me-2"></i> Pesanan Tidak Ditemukan</h5>
                            <p class="mb-0">Kode order yang Anda cari tidak ditemukan. Silakan periksa kembali kode order Anda.</p>
                        </div>
                        <div class="d-grid">
                            <a href="{{ route('client.track.order') }}" class="btn btn-primary">
                                Coba Lagi
                            </a>
                        </div>
                    @endif
