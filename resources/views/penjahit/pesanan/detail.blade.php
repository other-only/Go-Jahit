...
@section('content')
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('penjahit.pesanan.index') }}" class="btn btn-secondary btn-sm">
    ...
    <div class="modal fade" id="updateStatusModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('penjahit.pesanan.status', $order->id) }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="confirmOrderModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{ route('penjahit.pesanan.confirm', $order->id) }}" method="POST">
                    @csrf
                    <div class="modal-header">
